  ...
  return (
    <div className={cn('relative p-px overflow-hidden', containerClassName)} style={{ borderRadius: rx }}>
      ...
      <div className="absolute inset-0" style={{ borderRadius: rx }}>
        ...
        <motion.div
          ...
          style={{
            ...
            left: 0,
            transform,
            background: 'radial-gradient(circle at center, rgba(201,168,76,0.9) 0%, rgba(201,168,76,0.3) 40%, transparent 70%)',
          }}
        />
      </div>
      ...
      <div
        ...
        style={{ borderRadius: rx, border: '1px solid rgba(201,168,76,0.4)' }}
      />
      {/* Content */}
